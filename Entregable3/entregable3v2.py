...
if __name__ == '__main__':
    ...
    if 1 < len(sys.argv) == 2:
        ...
        for problemas in leer_fichero(file):
            ...
            for i in range(len(problemas)-1):
                word_list.append(problemas[i])

            word_solution = problemas[-1]
            list_letters = get_letters(word_list, word_solution)

            soluciones = list(cryptoA_solver(word_list, word_solution, list_letters))
